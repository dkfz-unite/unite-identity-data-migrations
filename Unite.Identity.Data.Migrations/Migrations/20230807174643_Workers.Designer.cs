...
namespace Unite.Identity.Data.Migrations.Migrations
{
    ...
    [Migration("20230807174643_Workers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unite.Identity.Data.Entities.Worker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Unite.Identity.Data.Entities.WorkerPermission", b =>
                {
                    ...
                    b.HasKey("WorkerId", "PermissionId");

                    b.HasIndex("PermissionId");

                    b.ToTable("WorkerPermissions", (string)null);
                });
            ...
            modelBuilder.Entity("Unite.Identity.Data.Entities.WorkerPermission", b =>
                {
                    ...
                    b.HasOne("Unite.Identity.Data.Entities.Worker", "Worker")
                        .WithMany("WorkerPermissions")
            ...
            modelBuilder.Entity("Unite.Identity.Data.Entities.Worker", b =>
                {
                    b.Navigation("WorkerPermissions");
                });
